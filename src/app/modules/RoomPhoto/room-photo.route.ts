...
router.post(
  '/',
  validateRequest(roomPhotoValidation.createRoomPhoto),
  roomPhotoController.createRoomPhoto
);

router.post(
  '/many',
  validateRequest(roomPhotoValidation.createManyRoomPhoto),
  roomPhotoController.createManyRoomPhoto
);
